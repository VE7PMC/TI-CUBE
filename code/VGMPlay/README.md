...
Source code to generate a TMS 9900 object format code utility that will decode an play back [VGM format](https://vgmrips.net/wiki/VGM_Specification) sound files.
